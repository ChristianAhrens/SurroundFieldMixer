...
"%PROJUCERVSDIR%\x64\Release\App\Projucer.exe" --resave %WORKSPACE%\SurroundFieldMixer.jucer
echo.

echo Build release
"%VSDIR%\devenv.com" %WORKSPACE%\Builds\VisualStudio2022\SurroundFieldMixer.sln /build Release
echo.
